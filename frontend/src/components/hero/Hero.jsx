        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end mt-4 lg:mt-0">
            <div className="relative w-full max-w-[280px] sm:max-w-sm md:max-w-md lg:max-w-lg">
              ...
              {CATEGORY_CARDS.map(({ icon: Icon, label, className, delay }) => (
                <div
                  key={label}
                  style={{ animationDelay: delay }}
                  className={`animate-hero-float hidden sm:flex absolute items-center gap-1.5 bg-white/80 backdrop-blur-md rounded-xl shadow-lg px-3 py-2 ${className}`}
                >
