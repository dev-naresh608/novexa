    ...
    <>
      <div className="w-full lg:w-[380px] rounded-2xl border p-5 shadow-sm">
            ...
            {!addressList ? (
              <div className="bg-red-50 border border-red-200 text-red-600 rounded-xl p-2 text-center text-sm">
                <button
                  ...
                  onClick={() =>
                    openModal(MODAL_TYPES.ADDRESS, { userId, setAddress })
                  }
                >
                  + Add Address
                </button>
        ...
        {isLogin ? (
          ...
          <button
            className="flex items-center gap-2 px-3 w-full justify-center active:scale-95 mt-6 bg-red-600 hover:bg-red-800 text-white py-2.5 rounded-xl font-medium transition"
